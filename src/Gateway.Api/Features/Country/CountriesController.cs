...
using Gateway.Api.Features.Country.Models;
using Gateway.Api.Features.Country.Requests;
...
public class CountriesController : ControllerBase
{
    ...
    public async Task<IActionResult> CreateAsync([FromBody] Models.Country request, CancellationToken ct)
    {
    ...
    public async Task<IActionResult> UpdateAsync([FromRoute] string code, [FromBody] Models.Country request,
        CancellationToken ct)
    {
    ...
    private static Models.Country ToCountry(People.Grpc.Infrastructure.Country country) =>
        new(
            country.Alpha2Code,
            country.Alpha3Code,
            country.Capital,
