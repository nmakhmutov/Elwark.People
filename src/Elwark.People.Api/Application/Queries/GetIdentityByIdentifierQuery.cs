...
{
    public class GetIdentityByIdentifierQuery : IRequest<IdentityResponse?>
    {
        [DebuggerStepThrough]
    ...
    public class GetIdentityByIdentifierQueryHandler : IRequestHandler<GetIdentityByIdentifierQuery, IdentityResponse?>
    {
...
";
        ...
        public Task<IdentityResponse?> Handle(GetIdentityByIdentifierQuery request,
