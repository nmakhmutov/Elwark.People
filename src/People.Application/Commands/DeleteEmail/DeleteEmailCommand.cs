...
namespace People.Application.Commands.DeleteEmail;

public sealed record DeleteEmailCommand(AccountId Id, MailAddress Email) : ICommand;

public sealed class DeleteEmailCommandHandler : ICommandHandler<DeleteEmailCommand>
{
