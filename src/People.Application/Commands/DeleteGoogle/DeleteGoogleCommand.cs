...
public sealed record DeleteGoogleCommand(AccountId Id, string Identity) : ICommand;

public sealed class DeleteGoogleCommandHandler : ICommandHandler<DeleteGoogleCommand>
{
