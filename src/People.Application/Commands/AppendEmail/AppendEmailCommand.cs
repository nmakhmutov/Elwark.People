...
namespace People.Application.Commands.AppendEmail;

public sealed record AppendEmailCommand(AccountId Id, MailAddress Email) : ICommand<EmailAccount>;

public sealed class AppendEmailCommandHandler : ICommandHandler<AppendEmailCommand, EmailAccount>
{
