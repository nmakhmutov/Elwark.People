...
using People.Account.Api.Application.Behaviors;
using People.Account.Api.Application.IntegrationEventHandlers;
using People.Account.Api.Grpc;
using People.Account.Api.Infrastructure.EmailBuilder;
using People.Account.Api.Infrastructure.Interceptors;
