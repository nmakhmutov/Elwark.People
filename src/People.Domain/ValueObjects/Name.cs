...
public sealed class Name : ValueObject
{
    ...
    )
    {
        ...
        return new Name(nickname, firstName?.Trim(), lastName?.Trim(), preferNickname);
    }

    public static Name Create()
    {
        var name = $"{Left[Random.Shared.Next(Left.Length)]}_{Right[Random.Shared.Next(Right.Length)]}";
        return Create(Nickname.Parse(name));
    }
